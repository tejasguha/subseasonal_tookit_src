# Predicts outcomes using Persistence++ with CCSM4 forecasts
#
# Example usage:
#   python models/perpp_ccsm4/batch_predict.py contest_tmp2m 34w -t std_val -y all -m None
#   python models/perpp_ccsm4/batch_predict.py contest_precip 34w -t std_val -y 20 -m 56
#
# Positional args:
