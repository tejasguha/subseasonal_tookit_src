...
cmd_script = resource_filename("subseasonal_toolkit",os.path.join("models", MODEL_NAME, "batch_predict.py"))
...
batch_script=resource_filename("subseasonal_toolkit", os.path.join("batch", "batch_python.sh"))
metrics_prefix=f"{batch_script} --memory 2 --cores 1 --hours 0 --minutes 3"
metrics_script=resource_filename("subseasonal_toolkit", os.path.join("batch_metrics.py"))
